  ...
  return (
    <section className="bg-black text-white py-10 px-6">
      ...
      <div className="text-center mb-20">
        ...
        <p className="text-gray-400 mt-3 text-sm text-center tracking-wide leading-relaxed">
          Not just another course — a{" "}
          <span className="text-white font-medium">
            complete transformation
          </span>{" "}
          designed to make you a confident, job-ready developer.
        </p>
      </div>
