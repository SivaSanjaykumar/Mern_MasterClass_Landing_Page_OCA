...
const details = [
  {
    icon: <Video size={18} className="text-[#A6FF5D]" />,
    title: "Live Online",
    desc: "Interactive Zoom session",
  },
  {
    icon: <Clock size={18} className="text-[#A6FF5D]" />,
    title: "8 Hours Intensive",
    desc: "Deep dive full-stack training",
  },
  {
    icon: <Calendar size={18} className="text-[#A6FF5D]" />,
    title: "15th Mar 2026",
  ...
  {
    icon: <Award size={18} className="text-[#A6FF5D]" />,
    title: "Certificate of Completion",
    desc: "Get certified after the masterclass",
  },
  {
    icon: <PlayCircle size={18} className="text-[#A6FF5D]" />,
    title: "Recorded Session Access",
    desc: "Rewatch anytime at your own pace",
  },
];
...
const MasterclassDetails = () => (
  <section
    ...
    className="bg-black text-white py-10 sm:py-10 px-4 sm:px-6"
  >
    {/* Heading */}
